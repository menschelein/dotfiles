...
alias connect-herrenberg='nmcli device wifi connect UPC1361924 password af6hhfj3mdsW'
alias connect-hotspot='nmcli device wifi connect ZentrumDerMacht password ichbindoof'
alias connect-reha='nmcli device wifi connect MeinHotspot password 2WAtxGE9'
